...
import uk.co.diyaccounting.persistence.DaoImpl;
...
import uk.co.diyaccounting.persistence.ops.TestEntityWithoutHash;
...
public class DaoImplTest {
   ...
   public void expectSingleResultTakenFromMockedTransactionManager() {
      ...
      // Execute
      TestEntity actualEntity = (TestEntity) classUnderTest.retrieve(entity);
   ...
   public void expectSingleResultFromRetrieveIfExistsTakenFromMockedTransactionManager() {
      ...
      // Execute
      TestEntity actualEntity = (TestEntity) classUnderTest.retrieveIfExists(entity);
      Assert.assertEquals(entity, actualEntity);
   }
   ...
   public void expectSingleResultByHashTakenFromMockedTransactionManager() {
      ...
      // Execute
      TestEntity actualEntity = (TestEntity) classUnderTest.retrieveByHash(entity);
   ...
   public void expectSingleResultWhichDoesNotNeedCreatingWithMockedTransactionManager() {
      ...
      // Execute
      TestEntity actualEntity = (TestEntity) classUnderTest.createOrUpdateAndRetrieve(entity);
      Assert.assertEquals(entity, actualEntity);
   }
   ...
   public void expectSingleResultWhichNeededToBeCreatedWithMockedTransactionManager() {
      ...
      // Execute
      TestEntity actualRegion = (TestEntity) classUnderTest.createOrUpdateAndRetrieve(entity);
   ...
   public void expectRemoveAllToCallMockedEntityManager() {
      ...
      classUnderTest.removeAll(TestEntity.class);
   }}