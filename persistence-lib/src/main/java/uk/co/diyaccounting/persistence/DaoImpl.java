...
javax.persistence.PersistenceException: org.hibernate.exception.ConstraintViolationException:
	...
	at uk.co.diyaccounting.persistence.TransactionManagerImpl.persist(TransactionManagerImpl.java:193)
	at uk.co.diyaccounting.persistence.DaoImpl.createOrUpdateAndRetrieve(DaoImpl.java:89)
	at uk.co.diyaccounting.crm.dao.PurchaseDaoImpl.createPayPalNewCustomer(PurchaseDaoImpl.java:135)
	at uk.co.diyaccounting.crm.service.OrderServiceConsumerImpl.persistCustomerAndPurchase
	   (OrderServiceConsumerImpl.java:104)
	at uk.co.diyaccounting.crm.messaging.OrderServiceDispatcherStubImpl.persistCustomerAndPurchase
	   (OrderServiceDispatcherStubImpl.java:30)
	at uk.co.diyaccounting.crm.service.OrderServiceProducerImpl.createOrder(OrderServiceProducerImpl.java:133)
	at uk.co.diyaccounting.present.controller.CompletionController.confirm(CompletionController.java:270)
