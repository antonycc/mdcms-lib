...
public class StandaloneServiceImpl implements StandaloneService {
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.diyaccounting.present.service.StandaloneService#getAbout()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.diyaccounting.present.service.StandaloneService#getInfo()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.diyaccounting.present.service.StandaloneService#getAboutContentItemPath()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.diyaccounting.present.service.StandaloneService#setAboutContentItemPath(java.lang.String)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.diyaccounting.present.service.StandaloneService#getInfoContentItemPath()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.diyaccounting.present.service.StandaloneService#setInfoContentItemPath(java.lang.String)
    */
   @Override
