 ...
 */
public final class TestBeanExceptionTwo extends Exception {
    ...
    */
   public TestBeanExceptionTwo(final Throwable cause) {
      super(cause);
   }
    ...
    * @see java.lang.Exception#Exception(Throwable)
    */
   public TestBeanExceptionTwo(final String message) {
      super(message);
   }
    ...
    * @see java.lang.Exception#Exception(Throwable)
    */
   public TestBeanExceptionTwo(final String message, final Throwable cause) {
      super(message, cause);
   }
}
