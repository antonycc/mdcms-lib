...
import uk.co.polycode.mdcms.persistence.UniqueQuery;
...
@NamedQueries({
         @NamedQuery(
                  name = "TestEntityTwo." + TransactionManager.FIND_ALL_QUERY,
                  query = "SELECT te "
                           + "FROM test_entity te"),
         @NamedQuery(
                  name = "TestEntityTwo." + TransactionManager.FIND_UNIQUE_QUERY,
                  query = "SELECT te "
                           + "FROM TestEntityTwo te "
                           + "WHERE "
                           + "te.name = :name") ,
			@NamedQuery(
					name = "TestEntityTwo." + TransactionManager.FIND_BY_HASH_QUERY,
					query = "SELECT te "
							+ "FROM TestEntityTwo te "
							+ "WHERE "
							+ "te.hash = :hash")
...
public class TestEntityTwo extends UniqueQuery implements Serializable {
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.polycode.mdcms.persistence.Unique#setUniqueParameters(javax.persistence.Query)
    */
   @Override
   public void setUniqueParameters(final Query query) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see uk.co.polycode.mdcms.persistence.Unique#setHashParameters(javax.persistence.Query)
	 */
	@Override
   ...
   public void copyAttributesForUpdate(final ComparableUsingString o) {
      TestEntityTwo entity = (TestEntityTwo)o;
