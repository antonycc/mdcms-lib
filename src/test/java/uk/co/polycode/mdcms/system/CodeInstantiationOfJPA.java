...
public class CodeInstantiationOfJPA {
   ...
   public void expectEntityToReturnWithAGeneratedPrimaryKey() throws Exception {
      ...
      String query = "SELECT te FROM TestEntityTwo te";

      // Expected results
      TestEntityTwo newEntity = new TestEntityTwo();
      ...
      List<TestEntityTwo> entities = entityManager.createQuery(query).getResultList();
      ...
      TestEntityTwo readEntity = entities.get(0);
