...
import uk.co.polycode.mdcms.cms.type.XmlContentsFieldType;
...
public abstract class Metadata extends NameBody implements Comparable<Metadata> {
    ...
    */
   @Content(path = MAIN_CONTENT + "/div/table/tbody/tr[td='short-title']/td[last()]")
    ...
    */
   @Content(path = MAIN_CONTENT + "/div/table/tbody/tr[td='precedence']/td[last()]", defaultValue = "0")
    ...
    */
   @Content(path = MAIN_CONTENT + "/div/table/tbody/tr[td='featured']/td[last()]")
    ...
    */
   @Content(path = MAIN_CONTENT + "/div/table/tbody/tr[td='featuredPartner']/td[last()]")
   private boolean featuredPartner;

   /**
    * Image for this item
    */
   @Content(path = MAIN_CONTENT + "/div/table/tbody/tr[td='image']/td[last()]//img", type = XmlFieldType.class)
   ...
   @Content(
            path = MAIN_CONTENT + "/*",
            prune = {MAIN_CONTENT + "/div",
                     MAIN_CONTENT + "/ul[@id=\"attachments\"]"},
