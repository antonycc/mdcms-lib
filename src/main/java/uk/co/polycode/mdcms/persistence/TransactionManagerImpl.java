...
public class TransactionManagerImpl implements TransactionManager {
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.polycode.mdcms.persistence.dao.CatalogueTransactionManager#beginTransaction()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.polycode.mdcms.persistence.dao.CatalogueTransactionManager#beginReadOnlyTransaction()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.polycode.mdcms.persistence.dao.CatalogueTransactionManager#endTransaction()
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.polycode.mdcms.persistence.dao.CatalogueTransactionManager#persist(java.lang.Object)
    */
   @Override
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.polycode.mdcms.persistence.dao.CatalogueTransactionManager#createNamedQuery(java.lang.Class)
    */
   @Override
   ...
   public Query createFindUniqueQuery(final Class<?> clazz) {
      ...
      String namedQuery = entityName + "." + FIND_UNIQUE_QUERY;
   ...
   public Query createFindByHashQuery(final Class<?> clazz) {
      ...
      // Build the query expecting to find a named query
      String namedQuery = entityName + "." + FIND_BY_HASH_QUERY;
      Query query = this.createNamedQuery(namedQuery);
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.polycode.mdcms.persistence.dao.CatalogueTransactionManager#getAll(java.lang.Class)
    */
   @Override
   public List<?> getAll(final Class<?> clazz) {
      ...
      // Build the query expecting to find a named query
      String namedQuery = entityName + "." + FIND_ALL_QUERY;
    ...
    * (non-Javadoc)
    * 
    * @see uk.co.polycode.mdcms.persistence.dao.CatalogueTransactionManager#remove(java.lang.Object)
    */
   @Override
